...
<body class="vertical-layout vertical-menu-modern dark-layout  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="" data-layout="dark-layout">
    ...
    <!-- BEGIN: Header-->
    <div> <?php include 'imp/header2.php' ?>
    <!-- END: Header-->


    <!-- BEGIN: Main Menu-->
    <div> <?php include 'imp/mainmenu2.php' ?>
    <!-- END: Main Menu-->
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="profile-img-container d-flex align-items-center">
                                        <div class="profile-img">
                                           ...
                                           /*if(empty($user['profile']) !== false) {
                                               echo '<img src=""', $user['profile'], '" alt="x"';
                                           }*/
                                           ?>
                                           </div>
                                        <!-- profile title -->
                            ...
                            <div class="col-lg-3 col-12 order-2 order-lg-1">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mt-2">
                                            <h5 class="mb-50">Funcții:</h5>
                                            <p class="card-text mb-0"><?php if($user["Admin"] == 3): echo '<button type="button" class="btn btn-primary">Executiv</button>'; elseif($user["Admin"] == 1): echo '<button type="button" class="btn btn-primary">Administrator</button>'; elseif($user["Admin"] == 0): echo 'Nu sunt asociate funcții acestui cont.'; endif; ?></p>
                                        </div>
                                    </div>
                                </div>
                                <!--/ about -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-start align-items-center mb-1">
                                            ...
                                            <!--/ avatar -->
                                            <div class="profile-user-info">
                                                <h6 class="mb-0">Kylie</h6>
                                                <small class="text-muted">11 Aug 2021</small>
                                            </div>
                                        </div>
                                        <p class="card-text">
                                            test test 2 - 10 dau cu zaru
                                        </p>
